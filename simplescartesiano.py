...
def GrafSegundoGrau():
    width = 10 if abs(a) > 1 or abs(a) == 0 else int(15 / abs(a))    # Se o valor de A for baixo, o gráfico será maior (maior amplitude).
...
num = input("Calcule uma equação do 2° grau! Aperte N para sair ou qualquer tecla para iniciar. ").upper()
